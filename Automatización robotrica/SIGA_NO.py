...
def executeBot():
        ...
        #boton No
        button = driver.find_element(By.XPATH,"//*[@id='divContenedorBloqueoAccesoHabilitado']/span/span[1]/div/div/ul/li[3]")
        button.click()
        time.sleep(5)
        ...
        #Mover Archivo
        shutil.move("C:/Users/ROBOTRPASI/Downloads/Reporte.Seguridad.CuentaUsuario_Perfilamiento.xlsx", "C:/Users/ROBOTRPASI/Pictures/Planos SIGA/TMP_SIGA_NO.xlsx")

        driver.close()
        #proc.terminate()
executeBot()

wb = load_workbook("C:/Users/ROBOTRPASI/Pictures/Planos SIGA/TMP_SIGA_NO.xlsx", read_only=False)
...
wb.save("C:/Users/ROBOTRPASI/Pictures/Planos SIGA/TMP_SIGA_NO.xlsx")
print('terminado')