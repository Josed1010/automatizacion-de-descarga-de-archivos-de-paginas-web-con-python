...
def executeBot():
        ...
        # View Issues
        time.sleep(5)
        driver.get('http://10.181.3.77:9502/xmlpserver/Oracle+Identity+Manager/TMP_OIM_USUARIOS.xdo')
        # Download report
        time.sleep(5)
        ...
        #Mover Archivo
        shutil.move("C:/Users/ROBOTRPASI/Downloads/TMP_OIM_USUARIOS_TMP_OIM_USUARIOS.xlsx", "C:/Users/ROBOTRPASI/Pictures/Carpeta de Planos/TMP_OIM_USUARIOS.xlsx")
...
wb = load_workbook("C:/Users/ROBOTRPASI/Pictures/Carpeta de Planos/TMP_OIM_USUARIOS.xlsx", read_only=False)

ws=wb["Sheet1"]

ws.unmerge_cells("A1:W1")
ws.delete_rows(1)

wb.save("C:/Users/ROBOTRPASI/Pictures/Carpeta de Planos/TMP_OIM_USUARIOS.xlsx")

archivo_excel = 'C:/Users/ROBOTRPASI/Pictures/Carpeta de Planos/TMP_OIM_USUARIOS.xlsx'

df = pd.read_excel(archivo_excel)

archivo_txt = 'S:/PLANOS/TMP_OIM_USUARIOS.txt'
