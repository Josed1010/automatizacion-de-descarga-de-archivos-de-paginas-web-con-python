...
def executeBot():
        ...
        # Get the page. 
        driver.get('https://mantis.colcomercio.com.co:8080/sac/login_page.php')
        time.sleep(5)
        ...
        # View Issues
        time.sleep(5)
        driver.get('https://mantis.colcomercio.com.co:8080/sac/accessadmin_reportes_acceso.php')
        # Download report
        time.sleep(5)
        ...
        #Mover Archivo
        shutil.move(archivo, "C:/Users/ROBOTRPASI/Pictures/Carpeta de Planos/TMP_SACAUDITORIA_USUARIOS.xlsx")
...
archivo_excel = 'C:/Users/ROBOTRPASI/Pictures/Carpeta de Planos/TMP_SACAUDITORIA_USUARIOS.xlsx'

df = pd.read_excel(archivo_excel)

archivo_txt = 'S:/PLANOS/TMP_SACAUDITORIA_USUARIOS.txt'
